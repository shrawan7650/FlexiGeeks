              ...
              <div class="overflow-hidden block">
                <nav>
                  ...
                  >
                    <li
                      role="tab"
                      class="flex justify-end text-center w-full h-full relative bg-transparent py-1 px-2 text-blue-gray-900 antialiased font-sans text-base font-normal leading-relaxed select-none cursor-pointer"
                      data-value="settings"
                    >
                      <div class="z-20 flex justify-center items-center gap-1 text-inherit">
