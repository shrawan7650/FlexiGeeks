  ...
  return (
    <div className="max-w-6xl mx-auto p-3">
      <div class="terms-of-service rounded-3xl bg-gray-100 p-8">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-bold mb-2">Use of Website</h2>
          <p class="mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-bold mb-2">User Accounts</h2>
          <p class="mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-bold mb-2">Third-Party Links</h2>
          <p class="mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-bold mb-2">Limitation of Liability</h2>
          <p class="mb-4">
            In no event shall [Your Company Name] or its affiliates be liable
